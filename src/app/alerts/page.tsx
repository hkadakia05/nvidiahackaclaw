  ...
  return (
    <PageFrame>
      ...
      <p className="mt-4 text-xs text-slate-500">
        {/* TODO: Replace placeholder rows when the backend exposes alert/incident data. */}
        Waiting for backend data. Backend alert endpoints do not exist yet, so
        this page keeps placeholder incident rows.
      </p>
