...
from app.run_manager import run_agent_timeline
...
async def websocket_run(websocket: WebSocket) -> None:
    """
    WebSocket endpoint for running the agent orchestration pipeline.
    ...
    try:
        ...
        await run_agent_timeline(db, websocket, task)
